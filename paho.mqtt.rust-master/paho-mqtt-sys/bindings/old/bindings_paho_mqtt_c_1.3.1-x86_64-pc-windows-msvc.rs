...
pub type MQTTPropertyCodes = i32;
extern "C" {
...
pub type MQTTPropertyTypes = i32;
extern "C" {
...
pub struct MQTTAsync_message {
    ...
    #[doc = " duplicate message."]
    pub dup: ::std::os::raw::c_int,
    #[doc = " The message identifier is normally reserved for internal use by the"]
    #[doc = " MQTT client and server."]
...
#[doc = " @return This function must return a boolean value indicating whether or not"]
#[doc = " the message has been safely received by the client application. Returning"]
#[doc = " true indicates that the message has been successfully handled."]
#[doc = " Returning false indicates that there was a problem. In this"]
...
pub union MQTTAsync_successData__bindgen_ty_1 {
    ...
    pub qos: ::std::os::raw::c_int,
    #[doc = " For subscribeMany, the list of granted QoSs of the subscriptions returned by the server."]
...
extern "C" {
    ...
    #[doc = " <i>protocol</i> must be <i>tcp</i> or <i>ssl</i>. For <i>host</i>, you can"]
...
pub struct MQTTAsync_SSLOptions {
    ...
    pub struct_id: [::std::os::raw::c_char; 4usize],
    #[doc = " The version number of this structure.    Must be 0, or 1 to enable TLS version selection."]
    pub struct_version: ::std::os::raw::c_int,
...
pub struct MQTTAsync_connectOptions {
    ...
    pub struct_id: [::std::os::raw::c_char; 4usize],
    #[doc = " The version number of this structure.  Must be 0, 1, 2, 3 4 5 or 6."]
...
extern "C" {
    ...
    #[doc = " this function returns successfully. If the client application needs to"]
...
extern "C" {
    #[doc = " Waits for a request corresponding to a token to complete."]
    #[doc = ""]
    #[doc = " @param handle A valid client handle from a successful call to"]
    #[doc = " MQTTAsync_create()."]
...
extern "C" {
    ...
    #[doc = " topic name. This is needed on Windows when the client libary and application"]
...
pub type MQTTASYNC_TRACE_LEVELS = i32;
extern "C" {
